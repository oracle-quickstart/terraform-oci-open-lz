# Manage Language Service Landing Zone Extension <!-- omit from toc -->
...
|                           |                                                                                                                                                                |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **DEPLOYMENT NAME**              | Language Service Landing Zone Extension                                                                                                                                    |
| **OBJECTIVE**             | Provision OCI Language Service Landing Zone IAM Extensions.                                                                                                    |
| **TARGET RESOURCES**      | **Security**: Compartments, Groups, Policies</br>                                                      |
| **IAM CONFIGURATION**     | [language_identity.auto.tfvars.json](/workload-extensions/oci-lz-ext-ai-services/language/language_identity.auto.tfvars.json) |
...
For configuring and running the OneOE Landing Zone language services extension Identity Layer use the following JSON file: [language_identity.auto.tfvars.json](/workload-extensions/oci-lz-ext-ai-services/language/language_identity.auto.tfvars.json) You can customize this configuration to fit your exact OCI IAM topology.
...
<img src="../diagrams/language-compartments.png" width="1000" height="auto">

&nbsp; 

The language service extension provisions a single compartment under the production project area.
...
| Group                      | Description                                                               |
| -------------------------- | ------------------------------------------------------------------------- |
| grp-p-project-language-admins | Members of the group are able to administer language service project and accompained services |
...
| -------------------------- | ------------------------------------------------------- | ---------------------------- | ------------------------------- | ----------------- |
| pcy-p-project-language-admins | Grants group *grp-p-project-language-admins* perminssions. |  | ai-service-language-family, object family |      |
...
-var-file ../terraform-oci-open-lz/workload-extensions/oci-lz-ext-ai-services/language/language_identity.auto.tfvars.json
```
