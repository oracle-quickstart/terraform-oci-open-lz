...
| **5** | **Runtime**           | - There are be **two deployment steps** to provision this landing zone: **(1)** The One-OE LZ will be used as an initial setup and **(2)** extended with the AI Services LZ Extension Runtime configurations. </br>- For more details refer to the [Runtime](#5-runtime-view) section. |
