# Manage Vision Service Landing Zone Extension <!-- omit from toc -->
...
|                           |                                                                                                                                                                |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **DEPLOYMENT NAME**              | Vision Service Landing Zone Extension                                                                                                                                    |
...
For configuring and running the OneOE Landing Zone vision services extension Identity Layer use the following JSON file: [vision_identity.auto.tfvars.json](/workload-extensions/oci-lz-ext-ai-services/vision/vision_identity.auto.tfvars.json) You can customize this configuration to fit your exact OCI IAM topology.
...
<img src="../diagrams/vision-compartments.png" width="1000" height="auto">

&nbsp; 

The vision service extension provisions a single compartment under the production project area.
...
| Group                      | Description                                                               |
| -------------------------- | ------------------------------------------------------------------------- |
| grp-p-project-vision-admins | Members of the group are able to administer vision service project and accompained services |
...
| -------------------------- | ------------------------------------------------------- | ---------------------------- | ------------------------------- | ----------------- |
| pcy-p-project-vision-admins | Grants group *grp-p-project-vision-admins* perminssions. |  | ai-service-vision-family, object family |      |
...
-var-file ../terraform-oci-open-lz/workload-extensions/oci-lz-ext-ai-services/vision/vision_identity.auto.tfvars.json
```
